...
public class Player2_InteractManager : MonoBehaviour
{
    ...
    private float _interactCoolTime = 0.0f; // 상호작용 쿨타임
    ...
    /*_searchRadius 안에 있는 애들 찾음(Collider2D)
     * 그중 Intreractable 컴포넌트가 있는 애들을 찾음 -> possibleTargets에 추가
     * 하나라도 있으면 맨 첫번째꺼를 _interactTarget으로 설정
    */
    ...
    /*
     *UpdateTargetInteractable로 찾은 _interactTarget의 UI를 찾음 
     */
